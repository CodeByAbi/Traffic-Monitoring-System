...
# Force CPU usage (disable CUDA) and use a smaller model for CPU-friendly inference
...
# Use a smaller YOLO model by default for CPU. If you have GPU and want better speed,
# change to yolov8l.pt and remove the model.to('cpu') line below.
model = YOLO("./YoloWeights/yolov8n.pt")
# ensure the model runs on CPU
model.to('cpu')

# Optional: save the displayed output to a video file. Set to True to enable.
SAVE_OUTPUT = False
OUT_PATH = "output_trafficMonitor.mp4"
writer = None
if SAVE_OUTPUT:
